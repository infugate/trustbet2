...
function Contact() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/admin/getAllMines`)
            .then(response => {
                const formattedData = response.data.map((bet, index) => ({
                    ...
                    betAmount: bet.betAmt,
                    totalBets: bet.winningAmt,
    ...
    const columns = [
        ...
        { field: "totalBets", headerName: "Winning Amount", flex: 1 },
        { field: "betPlaced", headerName: "Bet Placed", flex: 1 },
        { field: "profit", headerName: "loss Amt", flex: 1 },
    ...
    return (
        <Box m="0.5rem 1rem">
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                <Header title="Mines Bets" subtitle="List of All User Bets" />
                <div>
